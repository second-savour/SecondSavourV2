...
function Page() {
  ...
  return (
    <>
      <NextSeo
        title="About Second Savour | Vancouver BC"
        description="Learn about Second Savour's mission, team, and commitment to sustainability in Vancouver BC."
        canonical="https://second-savour-qa.vercel.app/about"
      />
