        ...
        <div className="flex flex-col gap-[5vh] lg:gap-[15vh] min-h-fit border-5 text-center w-[90%]">
          ...
          <section className="p-0 overflow-hidden overflow-x-hidden">
            ...
            <div className="text-left flex flex-col lg:flex-row mt-[4%] gap-[2%]">
              ...
              <p className="mt-[1rem] lg:mt-0">
                {" "}
                <p className="mb-[1%] font-bold">Team Bond</p>At Second Savour,
                we believe that a strong team is built on genuine connections
                and shared experiences. Our team socials are more than just
                events; they&apos;re a chance to bond, unwind, and celebrate our
