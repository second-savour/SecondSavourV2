...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Password length validation (frontend check)
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-black mb-6">SIGN UP</h1>
            <p className="text-gray-700 text-lg">Create your account to get started</p>
          </div>
          ...
          <div className="text-center mb-12">
            <p className="text-gray-700 text-lg">
              ...
              <a href="/signIn" className="text-black underline hover:text-gray-600 transition-colors font-semibold">
                Sign In
              </a>
            </p>
          </div>
