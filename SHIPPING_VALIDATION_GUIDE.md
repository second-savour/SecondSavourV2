...
- Shipping fees are automatically calculated based on validation:
  ...
  - **Free**: Any Canadian city with orders $15+ (before tax)
  - **$10**: Other Canadian cities (orders under $15)
...
2. **Non-Lower Mainland (under $15)**
   - Enter "Toronto" → Should show yellow validation, $10 shipping
   
3. **Non-Lower Mainland ($15+)**
   - Enter "Toronto" with $15+ cart → Should show free shipping message
...
3. Confirm order total meets $15+ threshold for free shipping
